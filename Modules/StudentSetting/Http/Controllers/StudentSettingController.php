            ...
            ->addColumn('status', function ($query) {
                ...
                if (permissionCheck('student.edit')) {
                    ...
                    $student_edit = '  <button
                                                                    ...
                                                                    type="button">' . trans('Editar') . '</button>';
                } else {
                    $student_edit = "";
                }
                ...
                if (permissionCheck('student.delete')) {
                    ...
                    $student_delete = '<button class="dropdown-item deleteStudent"
                                                                    data-id="' . $query->id . '"
                                                                    type="button">' . trans('Eliminar') . '</button>';
                } else {
                    $student_delete = "";
                }
                if (permissionCheck('student.courses')) {

                    $student_courses = '<a class="dropdown-item" href="' . route('student.courses', $query->id) . '" data-id="' . $query->id . '" type="button">' . trans('') . '</a>';
                } else {
                    $student_courses = "";
                }
