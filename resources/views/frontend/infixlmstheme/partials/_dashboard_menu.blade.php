    ...
    <div class="category_search d-flex category_box_iner">
        ...
        <div class="row">
                <div class="col-12 text-center">
                    <!-- Facebook -->
<a href="https://www.facebook.com/chilesincancer" target="_blank"><i class="fab fa-facebook-f menuicon"></i></a>

<!-- Instagram -->
<a href="https://www.instagram.com/chilesincancer/" target="_blank"><i class="fab fa-instagram menuicon"></i></a>

<!-- Linkedin -->
<a href="https://cl.linkedin.com/company/fundaci%C3%B3n-chilesinc%C3%A1ncer" target="_blank"><i class="fab fa-linkedin-in menuicon"></i></a>


<!-- Youtube -->
<a href="https://www.youtube.com/channel/UChQ6Td90UMpLtD6L6sQSOEg" target="_blank"><i class="fab fa-youtube menuicon"></i></a>
    ...
    <div class="d-flex align-items-center">
        ...
        <div class="profile_info collaps_part">
            <div class="profile_img collaps_icon     d-flex align-items-center">
                ...
                <img src="{{getProfileImage(Auth::user()->image)}}" style="margin-bottom:60px;" class="img_home" width="150px"/><span class="">{{Auth::user()->name}}
