...
@section('content')
    ...
    <div class="login_wrapper">
        <div class="login_wrapper_left">
            <div class="logo">
                <a href="{{ url('/') }}">
                    <img style="width: 250px; margin-left:18%;" src="{{asset(Settings('logo') )}} " alt="">
                </a>
            </div>
            <div class="login_wrapper_content" style="margin-left:50px;">
                            ...
                            <div class="remember_forgot_passs d-flex align-items-center">
                                <label class="primary_checkbox d-flex" for="checkbox">
                                    ...
                                    <p>{{__('frontend.By signing up, you agree to')}} <a target="_blank"
                                                                                         href="#">{{__('frontend.Terms of Service')}}</a> {{__('frontend.and')}}
                                        <a target="_blank" href="#">{{__('frontend.Privacy Policy')}}.</a></p>
                                </label>
