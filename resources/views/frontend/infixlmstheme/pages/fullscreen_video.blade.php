...
@section('mainContent')
                    ...
                    <div class="col-12">
                        <div class="header__wrapper flex-wrap">
                            ...
                            <div class="header__left d-flex align-items-center">
                                <div class="logo_img">
                                    <a href="{{url('/')}}">
                                        <img class="p-2" style="width: 100px"
                                ...
                                <div class="contact_wrap d-flex align-items-center flex-wrap">
                                    <div class="contact_btn d-flex align-items-center flex-wrap">
                                        @if(isset($lessons))
                                            ...
                                            <span class="pl-2 text-nowrap">Avance automático</span>
    ...
    <div class="course_fullview_wrapper">
        ...
        @if (in_array($lesson->host,$video_lesson_hosts))
           <!-- <button
                class="theme_btn small_btn2 p-2 m-1 top_right_btn completeAndPlayNext"> Marcar como completado</button>-->
        @endif
                ...
                @if(!isset($_GET['done']))
                    <!-- quiz_test_header  -->
                        ...
                        <div class="quiz_test_body">
                            <h3>¡Felicidades! Ha completado el curso: {{$course->quiz->title}}</h3>
                            @if ($result['publish']==1)
                                <div class="">
                                    <div class="row">
                                        <div class="col-xl-12">
            ...
            @if ($lesson->host=='SCORM' || $lesson->host=='SCORM-AwsS3')
                @if(!empty($lesson->video_url))
                    ...
                    <iframe class=" video_iframe" id="video-id"
                            ...
                            height="95%" onunload="API.LMSFinish('');"
                        @endif
                    ></iframe>
        ...
        <div class="course__play_warp courseListPlayer ">
            ...
            <div class="course__play_list" style="margin-bottom:40px;">
                @php
                    $i=1;
                @endphp
                <div class="theme_according mb_30" id="accordion1" style="margin-bottom:120px;">
                            ...
                            <div class="card-header pink_bg" id="heading{{$chapter->id}}">
                                <h5 class="mb-0">
                                    <button class="btn btn-link text_white collapsed "
                                        ...
                                        {{$chapter->name}} <br>
                                        <!--<span
                                            class="course_length nowrap"> {{count($chapter->lessons)}} Actividades</span>-->
                                    </button>
                                </h5>
                            </div>
                    ...
                    <div class="container">
                                        <div class="row">
                                            <a href="https://cstnr.chilesincancer.cl/" target="_blank"><center><img class="semaforo-sidebar-play" src="/public/frontend/infixlmstheme/img/semaforo-vertical.png"></center></a>
                                         </div>
                                     </div>
