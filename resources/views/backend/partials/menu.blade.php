                        ...
                        <form action="#">
                            <div class="search_field">
                                <input type="text" class="form-control primary-input input-left-icon"
                                       placeholder="Buscar" id="search" onkeyup="showResult(this.value)">
                            </div>
                        ...
                        <div class="profile_info_iner">
                            ...
                            <div class="profile_info_details">
                                ...
                                @if(isModuleActive('UserType'))
                                    ...
                                    @endforeach
                                @endif
                                @if ((isModuleActive('LmsSaas') && Auth::user()->is_saas_admin==1) || isModuleActive('LmsSaasMD') && Auth::user()->is_saas_admin==1)
